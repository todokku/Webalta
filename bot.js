...
if(config.logging){
console.log(`Смена цвета роли на ${rainbow[place]}. Произошло на сервере: ${servers[index]}`);
}
if(place == (size - 1)){
place = 0;
}else{
...
bot.on('ready', () => {
if(config.speed < 2000){console.log("Минимум 2000 не опускайте иначе бота забанят!"); process.exit(1);}
