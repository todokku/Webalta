...
module.exports.run = async (bot, message, args) => {
    ...
    module.exports = { // Создаём экспорты.
     ...
     run: async (bot, message, args) => {
        ...
        if (!guild) return message.channel.send("Ошибка. Описание: Бот не находится на сервере с указанным ID"); // Ошибка
        ...
        message.channel.send(embed); // Отправляем готовый эмбед.
        }
    }
